...
like for example projecting a point cloud directly into the image plane. Therefore, each image file is accompanied
with a point cloud file of the corresponding view.
...
However, the IDs do not match in regard of time across the views.
...
The point positions over the two revolutions were thus compensated by the vehicle's egomotion (0.1s*30km/h = 83.33cm)
...
This leads to point duplicates (same timestamp, different position due to vehicle egomotion compensation),
